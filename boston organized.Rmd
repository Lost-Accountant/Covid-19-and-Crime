...
VAR_investigate <- VAR(y=as.ts(combined_diff[,c(1,6)]), p=p)
VAR_damage <- VAR(y=as.ts(combined_diff[,c(2,6)]), p=p)
VAR_medical <- VAR(y=as.ts(combined_diff[,c(3,6)]), p=p)
VAR_vandalism <- VAR(y=as.ts(combined_diff[,c(4,6)]), p=p)
VAR_dispute <- VAR(y=as.ts(combined_diff[,c(5,6)]), p=p)
```
