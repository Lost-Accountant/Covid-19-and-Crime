...
MA_res_lag <- lag.xts(MA_res_ts, k = 4)
```
...
VAR_dispute <- vars::VAR(y=na.omit(combined_diff), p = 10)
...
```{r VAR vandalism}
# VAR model estimation
VAR_vandalism <- vars::VAR(y=na.omit(combined_vandalism_diff), p = 10)
