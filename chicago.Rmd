...
common_time <- seq.Date(start(CH_res_ts), end(top5crime_diff), by = "day")
...
```
Very significant causality on criminal damage (p-value = 0.01221)
...
```
COVID-19 may help to predict theft. (p-value = 0.05294)
...
```
covid-19 is significant to vehicle theft (p-value = 0.005237)
