...
#phil <- read.csv('C:/Users/sshan/Desktop/phillydata/phillydata.csv')
...
```
slightly signifigant instantenous causality between thefts and COVID-19 (0.07509)
...
```{r irf graphs, theft from vehicle, theft, vandalism}
### code to produce the irf graphs in ggplot and ggplotly
### theft from vehicle irf graph
...
###  ggplot version of irf graph of theft from vehicle
...
irf_vehicle_2_ggly <-  ggplot(irf_vehicle_2_gg, aes(x = lags)) +
  geom_line(aes(y = mean), color = "black") +
  geom_hline(yintercept = 0, color = "blue") +
  geom_ribbon(aes(ymin = lower, ymax = upper), fill = "lightblue", alpha = 0.5) +
  theme_classic() +
  ggtitle("Increase in incidents of theft from vehicle per day after 1 confirmed covid19 case") +
  xlab("Number of days after 1 covid19 case") +
  ylab("Number of thefts from vehicle per day")

irf_vehicle_2_ggly

######### irf graph of theft
###weak signifigance for instantenous causality
...
irf_theft_1 <- irf(VAR_thefts, 
                         ...
                         response = "residuals", 
                         n.ahead = 24)
irf_theft_2 <- irf(VAR_thefts, 
                         impulse = "residuals", 
                         response = "thefts", 
                         n.ahead = 24)

###  ggplot version of irf graph of theft
#irf_theft_2, impulse = residuals (COVID), response = theft
irf_theft_2_gg <- data.frame(
  irf_theft_2$irf$residuals[,1],
  irf_theft_2$Lower$residuals[,1],
  irf_theft_2$Upper$residuals[,1])

colnames(irf_theft_2_gg) <- c("mean", "lower", "upper")

irf_theft_2_ggly <-  ggplot(irf_theft_2_gg, aes(x = lags)) +
  geom_line(aes(y = mean), color = "black") +
  geom_hline(yintercept = 0, color = "blue") +
  geom_ribbon(aes(ymin = lower, ymax = upper), fill = "lightblue", alpha = 0.5) +
  theme_classic() +
  ggtitle("Increase in confirmed COVID19 cases after theft") +
  xlab("Number of days after 1 covid19 case") +
  ylab("Number of thefts per day")

irf_theft_2_ggly

######irf_theft_1, impulse = theft, response = residuals (COVID)
#irf_theft_1_gg <- data.frame(
  #irf_theft_1$irf$theft[,1],
  #irf_theft_1$Lower$theft[,1],
  #irf_theft_1$Upper$theft[,1])

#colnames(irf_theft_1_gg) <- c("mean", "lower", "upper")

#irf_theft_1_ggly <-  ggplot(irf_theft_1_gg, aes(x = lags)) +
  #geom_line(aes(y = mean), color = "black") +
  #geom_hline(yintercept = 0, color = "blue") +
  #geom_ribbon(aes(ymin = lower, ymax = upper), fill = "lightblue", alpha = 0.5) +
  #theme_classic() +
  #ggtitle("Increase in incidents of thefts per day after 1 confirmed covid19 case") +
  #xlab("Number of days after 1 incident of theft") +
  #ylab("Number of confirmed cases per day")
...
irf_vandalism_2 <- irf(VAR_vandalism, 
                         ...
                         response = "vandalism", 
                         n.ahead = 24)
irf_vandalism_2_gg <- data.frame(
  irf_vandalism_1$irf$vandalism[,1],
  irf_vandalism_1$Lower$vandalism[,1],
  irf_vandalism_1$Upper$vandalism[,1])
irf_vandalism_2_ggly <-  ggplot(irf_vandalism_1_gg, aes(x = lags)) +
  geom_line(aes(y = mean), color = "black") +
  geom_hline(yintercept = 0, color = "blue") +
  geom_ribbon(aes(ymin = lower, ymax = upper), fill = "lightblue", alpha = 0.5) +
  theme_classic() +
  ggtitle("Increase in incidents of vandalism per day after 1 confirmed covid19 case") +
  xlab("Number of days after 1 incident of vandalism") +
  ylab("Number of confirmed cases per day")

irf_vandalism_2_ggly
